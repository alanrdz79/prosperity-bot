"""
prosperityscal.py - Módulo 1 de 10: Dinámica Microestructural y Libro de Órdenes
Proyecto CONTINUITY - Scalping de Alta Frecuencia en SOL/USDT
...
if __name__ == "__main__":
    ...
    analyzer = MicrostructureAnalyzer(symbol="SOL/USDT")
    
    # 1. Simulación Inicial de Mercado Estático
    bid_p, bid_v = 150.00, 100.0
    ask_p, ask_v = 150.05, 120.0
    ...
    bid_p, bid_v = 150.00, 250.0
    ask_p, ask_v = 150.05, 90.0
    ofi = analyzer.calculate_ofi(bid_p, bid_v, ask_p, ask_v)
    mp = analyzer.calculate_micro_price(bid_p, bid_v, ask_p, ask_v)
    ...
    bid_p, bid_v = 150.05, 50.0
    ask_p, ask_v = 150.10, 200.0
    ofi = analyzer.calculate_ofi(bid_p, bid_v, ask_p, ask_v)
    mp = analyzer.calculate_micro_price(bid_p, bid_v, ask_p, ask_v)
